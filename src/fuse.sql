...
CREATE TABLE `fuse` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='id就是url的MD5生成的。\r\nopen_time访问开始会填写开始时间，\r\nclose_times访问结束会填写结束时间，\r\nsuccess_times如果成功则不会增加成功的次数\r\nfail_times如果失败则增加失败的次数\r\nstatus如果发现有失败的次数，并且上次时间在60秒以内，\r\n        中间有成功则增加成功次数，失败增加失败次数。\r\n        若达到失败3次以上，则打开state，将其设置为时间戳，并在30秒后重试，期间直接返回失败。\r\n';

-- ----------------------------
-- Records of fuse
-- ----------------------------
INSERT INTO `fuse` VALUES ('6b82469cfb3df2b862c3a0fc9796386f', '0', '1552882608', '1552882608', '0', '0');
INSERT INTO `fuse` VALUES ('f482acd84e43d61a25432b29bced6908', '1552883045', '1552879106', '1552885963', '0', '1');
